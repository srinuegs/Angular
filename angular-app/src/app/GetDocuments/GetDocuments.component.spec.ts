...
describe('GetDocumentsComponent', () => {
  ...
  let mockGetDocumentsService;
  let mockDataService

  beforeEach(async(() => {

    mockGetDocumentsService = sinon.createStubInstance(GetDocumentsService);
    mockGetDocumentsService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: GetDocumentsService, useValue: mockGetDocumentsService },
