...
describe('UpdateDocumentComponent', () => {
  ...
  let mockUpdateDocumentService;
  let mockDataService

  beforeEach(async(() => {

    mockUpdateDocumentService = sinon.createStubInstance(UpdateDocumentService);
    mockUpdateDocumentService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: UpdateDocumentService, useValue: mockUpdateDocumentService },
